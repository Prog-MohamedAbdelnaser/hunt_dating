package com.recep.hunt.data.sources.remote.di

import com.google.gson.GsonBuilder
import com.recep.hunt.utilis.SharedPrefrenceManager
import com.rent.client.data.sources.remote.RemoteConstants
import com.rent.client.data.sources.remote.interceptor.ErrorHandlerInterceptor
import com.rent.client.data.sources.remote.interceptor.HeadersInterceptor
...
val remoteModule = module {
    ...
    single<Interceptor>(keyHeadersInterceptor) { HeadersInterceptor(SharedPrefrenceManager.getUserToken(androidContext())) }
