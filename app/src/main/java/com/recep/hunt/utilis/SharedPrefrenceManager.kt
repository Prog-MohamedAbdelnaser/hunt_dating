...
object SharedPrefrenceManager {
    ...
    fun setIsOtpVerified(context: Context, value: Boolean) {
        val sharedPreferences =
            context.getSharedPreferences(Constants.prefsName, Context.MODE_PRIVATE)
    ...
    fun getsocialType(context: Context) =
        getSharePrefs(context, PersistenceKeys.socialType.toString())
    ...
    fun getUserDetailModel(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserModel.toString())
    ...
    fun getDeviceToken(context: Context) =
        getSharePrefs(context, PersistenceKeys.DeviceToken.toString())
    ...
    fun getUserFirstName(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserFirstName.toString())
    ...
    fun getUserLastName(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserLastName.toString())
    ...
    fun getUserEmail(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserEmail.toString())
    ...
    fun getUserImage(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserImage.toString())
    ...
    fun getUserLookingFor(context: Context, typeLookingFor: String) =
        getSharePrefs(context, typeLookingFor)
    ...
    fun getUserInterestedIn(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserInterestedIn.toString())
    ...
    fun getUserLatitude(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserLatitude.toString())
    ...
    fun getUserLongitude(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserLongitude.toString())
    ...
    fun getUserMobileNumber(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserMobileNumber.toString())
    ...
    fun getUserCountryCode(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserCountryCode.toString())
    ...
    fun getUserCountry(context: Context) =
        getSharePrefs(context, PersistenceKeys.UserCountry.toString())
    ...
    fun getCompanyName(context: Context) =
        getSharePrefs(context, PersistenceKeys.CompanyName.toString())
    ...
    fun getSchoolUniversity(context: Context) =
        getSharePrefs(context, PersistenceKeys.SchoolUniversity.toString())
    ...
    fun getFirstImg(context: Context) =
        getSharePrefs(context, PersistenceKeys.ProfileFirstImg.toString())

    fun setSecImg(context: Context, value: String) {
        setSharedPrefs(context, PersistenceKeys.ProfileSecImg.toString(), value)
    }

    fun getSecImg(context: Context) =
        getSharePrefs(context, PersistenceKeys.ProfileSecImg.toString())
    ...
    fun getThirdImg(context: Context) =
        getSharePrefs(context, PersistenceKeys.ProfileThirdImg.toString())
    ...
    fun getFourthImg(context: Context) =
        getSharePrefs(context, PersistenceKeys.ProfileFourImg.toString())
    ...
    fun getFiveImg(context: Context) =
        getSharePrefs(context, PersistenceKeys.ProfileFiveImg.toString())
    ...
    fun getSixImg(context: Context) =
        getSharePrefs(context, PersistenceKeys.ProfileSixImg.toString())
    ...
    fun getProfileImg(context: Context) =
        getSharePrefs(context, PersistenceKeys.ProfileImg.toString())
    ...
    fun getRelationShipStatus(context: Context) =
        getSharePrefs(context, PersistenceKeys.RelationShipStatus.toString())
    ...
    fun getUserEducationLevel(context: Context) =
        getSharePrefs(context, PersistenceKeys.EducationLevel.toString())
    ...
    fun getLookingFor(context: Context) =
        getSharePrefs(context, PersistenceKeys.LookingFor.toString())
...
//        Religion
    ...
    fun clearAllSharePreference(context: Context) {
        val sharedPreferences =
            context.getSharedPreferences(Constants.prefsName, 0).edit().clear().commit()
    }
    ...
    fun setUsrRelationship(context: Context, selectedOption: String) {
        val sharedPreferences = context.getSharedPreferences(Constants.prefsName, 0)
        val editor = sharedPreferences.edit()
        editor.putString(PersistenceKeys.RelationShipStatus.toString(), selectedOption)
        editor.apply()
    }

    fun getUsrRelationship(context: Context): String {
        val sharedPreferences = context.getSharedPreferences(Constants.prefsName, 0)
        sharedPreferences.getString(PersistenceKeys.RelationShipStatus.toString(), "")?.let {
            return it
        }
        return ""
    }
