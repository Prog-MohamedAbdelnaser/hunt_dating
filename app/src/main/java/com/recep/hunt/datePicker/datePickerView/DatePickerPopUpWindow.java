package com.recep.hunt.datePicker.datePickerView;
...
import com.recep.hunt.datePicker.datePickerUtils.DateUtils;

import java.util.Calendar;
import java.util.Locale;


public final class DatePickerPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    private void initView() {
        ...
        cancelButton = (TextView) rootView.findViewById(R.id.btn_cancel);
        confirmButton = (TextView) rootView.findViewById(R.id.btn_confirm);
