...
class BasicInfoViewModel(private val app: Application) : AndroidViewModel(app){
     fun getData():ArrayList<UserBasicInfoModel>{
        ...
        if(basicModel.size == 0){
            ...
            basicModel.add(UserBasicInfoModel("Height", SharedPrefrenceManager.getUserHeight(app.applicationContext), R.drawable.height_icon, questionModel[1]))
            basicModel.add(UserBasicInfoModel("Gym", SharedPrefrenceManager.getUserGym(app.applicationContext), R.drawable.gym_icon, questionModel[2]))
            basicModel.add(UserBasicInfoModel("Education level", SharedPrefrenceManager.getUserEducationLevel(app.applicationContext), R.drawable.education_icon,questionModel[3]))
            basicModel.add(UserBasicInfoModel("Drink", SharedPrefrenceManager.getUserDrink(app.applicationContext), R.drawable.drink_icon, questionModel[4]))
            basicModel.add(UserBasicInfoModel("Smoke", SharedPrefrenceManager.getSomke(app.applicationContext), R.drawable.smoke_icon, questionModel[5]))
            basicModel.add(UserBasicInfoModel("Pets",SharedPrefrenceManager.getPets(app.applicationContext), R.drawable.pets_icon, questionModel[6]))
            ...
            basicModel.add(UserBasicInfoModel("Zodiac", SharedPrefrenceManager.getZodiac(app.applicationContext), R.drawable.zodiac_icon, questionModel[9]))
            basicModel.add(UserBasicInfoModel("Religion", SharedPrefrenceManager.getReligion(app.applicationContext), R.drawable.religion_icon, questionModel[10]))
        }
        return basicModel
    }
