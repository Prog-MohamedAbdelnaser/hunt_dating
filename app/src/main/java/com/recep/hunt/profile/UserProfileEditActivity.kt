...
class UserProfileEditActivity : BaseActivity(), ProfileBasicInfoTappedListner {
    ...
    private fun sharePrefeImageSetup() {
        user_image_1.setImageBitmap(StringToBitmap(SharedPrefrenceManager.getFirstImg(this)))
        user_image_2.setImageBitmap(StringToBitmap(SharedPrefrenceManager.getSecImg(this)))
        user_image_3.setImageBitmap(StringToBitmap(SharedPrefrenceManager.getThirdImg(this)))
        user_image_4.setImageBitmap(StringToBitmap(SharedPrefrenceManager.getFourthImg(this)))
        user_image_5.setImageBitmap(StringToBitmap(SharedPrefrenceManager.getFiveImg(this)))
        user_image_6.setImageBitmap(StringToBitmap(SharedPrefrenceManager.getSixImg(this)))
