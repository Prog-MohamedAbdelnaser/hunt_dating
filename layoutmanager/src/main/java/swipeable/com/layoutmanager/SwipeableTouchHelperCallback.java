...
public class SwipeableTouchHelperCallback extends ItemTouchHelper.Callback {
  ...
  @Override
  public void onMoveMotionEventRight(float x, float xCord) {

  }

  @Override
  public void onMoveMotionEventLeft(float x, float xCord) {

  }

  @Override
  public void onMoveMotionEventCanceld() {

  }

  @Override
  public void onMoveMotionEventvVerticallyChange(float y, float yCord) {
    if ((yCord-y) > 60){
  ...
  @Override public final void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
    ...
    Log.i("onSwiped","direction "+direction);
