...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    public static class Builder {
        ...
        private String textConfirm = "Done";
        private String dateChose = getStrDate();
        private int colorCancel = Color.parseColor("#6B40BE");
        private int colorConfirm = Color.parseColor("#6B40BE");
...
//        dayLoopView.setTextSize(25);
    ...
    private void initPickerViews() {
        ...
        for (int j = 0; j < 12; j++) {
            monthList.add(parseDateToddMMyyyy(format2LenStr(j + 1)));
        }
    ...
    public static long getLongFromyyyyMMdd(String date) {
        SimpleDateFormat mFormat = new SimpleDateFormat("dd-MMMM-yyyy", Locale.getDefault());
        Date parse = null;
        try {
